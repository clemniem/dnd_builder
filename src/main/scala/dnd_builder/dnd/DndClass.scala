...
case object Barbarian extends DndClass:
  ...
  val weaponSummary      = "Simple & Martial weapons"
  val skillPool          = Set(
...
case object Bard extends DndClass:
  ...
  val weaponSummary      = "Simple weapons"
...
case object Monk extends DndClass:
  ...
  val weaponSummary      = "Simple weapons, Martial (Light)"
  val skillPool          = Set(
...
case object Rogue extends DndClass:
  ...
  val armorProficiencies = Set(ArmorType.Light)
  val weaponSummary      = "Simple weapons, Martial (Finesse/Light)"
  val skillPool          = Set(
