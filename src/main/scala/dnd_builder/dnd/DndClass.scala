...
case object Fighter extends DndClass {
  ...
  val recommendedScores    = AbilityScores(Score(15), Score(14), Score(13), Score(8), Score(10), Score(12))
...
case object Rogue extends DndClass {
  ...
  val recommendedScores    = AbilityScores(Score(12), Score(15), Score(13), Score(14), Score(10), Score(8))
  val level1Features       = List(
